    ...
    <>
      <Container>
        ...
        <div className="py-28 h-fit flex flex-col gap-8 justify-center items-center">
          ...
          <p className="text-center text-gray-500 dark:text-gray-400">
            We provide creativity and insight to deliver best website with best
            developers
          </p>
          ...
          <div className="flex gap-4 items-center">
            ...
            <NavLink to="">
              <Button01 className="w-fit">Book a Meet</Button01>
            </NavLink>
          </div>
        </div>
      </Container>
      ...
      <Container className="py-14">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 justify-center px-4">
          ...
          <div className="px-4">
            <MemberCard filters={{ contributionType: "Contributor" }} />
          </div>
        </div>
      </Container>
