...
const SearchJobs = () => {
    ...
    const handleSearch = () => {
        setShowResults(true);
        console.log("Searching for:", { keywords, experience, location });
    };
    ...
    return (
        <>
            <Container>
                    ...
                    >
                        ...
                        <div className={`${bgGrads} flex w-full h-12 focus-within:ring-1 ring-teal-600 dark:ring-teal-500`}>
                            ...
                            <input
                                ...
                                value={keywords}
                                onChange={(e) => setKeywords(e.target.value.trimStart())}
                            />
                            {keywords && (
                                <button
                        ...
                        <Button
                            ...
                            disabled={!keywords && !experience && !location}
                        >
                            Search Jobs
                        </Button>
                    </motion.div>
                ...
                {/* Job Results Section */}
                {showResults && <ShowJobs searchCriteria={{ keywords, experience, location }} />}
            </Container>
        </>
    )
}
